...
export default function LoginPage({ onLogin }) {
  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', background: '#F2F7FB', overflow: 'hidden' }}>
      {/* ===== Layer 0: All 3D canvases (behind everything, non-interactive) ===== */}
      <div style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        ...
        {/* Brand Halo (left side) */}
        <div style={{
          position: 'absolute', left: 0, top: 0, bottom: 0,
          width: 'calc(100% - 440px)', display: 'flex',
        ...
        <motion.div
          ...
          style={{
            ...
            color: '#1C1C1E', fontSize: '28px', fontWeight: 600,
        ...
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(circle at 30% 50%, rgba(10,132,255,0.08) 0%, transparent 60%)'
          }}
        />
      </div>

      {/* ===== Layer 10: Interactive content ===== */}
      <div style={{
